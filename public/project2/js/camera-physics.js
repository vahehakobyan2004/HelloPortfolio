...
function init() {
    ...
    ambientLight = new THREE.AmbientLight( 0x3D4143 ) 
    ...
    background = new THREE.Mesh( buffgeoBack, new THREE.MeshBasicMaterial( { map:gradTexture([[0.75,0.6,0.4,0.25], ['#1B1D1E','#3D4143','#72797D', '#b0babf']]), side:THREE.BackSide, depthWrite: false, fog:false }  ));
    background.geometry.applyMatrix(new THREE.Matrix4().makeRotationZ(15*ToRad));
